...
export function TaskListView() {
    ...
    return (
        <div className="w-full pb-20">
            {/* Header */}
            <div className="grid grid-cols-[40px_1fr_180px_140px_140px] gap-2 px-4 py-2 border-b border-border text-xs font-medium text-muted-foreground bg-muted/30">
...
function TaskRow({
    ...
    return (
        <div className="grid grid-cols-[40px_1fr_180px_140px_140px] gap-2 px-4 py-2 text-sm hover:bg-accent/50 group transition-colors items-center relative">
            ...
            <div className="flex justify-center">
                ...
                >
                    {task.status === 'DONE' ? <CheckCircle2 className="w-4 h-4 text-green-600" /> : <Circle className="w-4 h-4" />}
                </button>
            </div>

            {/* 2. Title (Click to open detail) */}
            <div className="font-medium text-foreground truncate cursor-pointer hover:underline hover:text-primary pr-4" onClick={onClick}>
                {task.title}
            </div>
            ...
            <div className="relative">
                ...
                >
                    ...
                    <span className={cn("text-xs truncate", !task.assigneeName && "text-muted-foreground italic")}>
            ...
            <div className="relative">
                <div
                    className={cn(
                        "flex items-center gap-1.5 px-2 py-1 rounded text-xs w-full max-w-[100px] cursor-pointer border border-transparent hover:border-border transition-all dropdown-trigger",
            ...
            <div className="relative">
                <div
                    className={cn(
                        "flex items-center gap-1.5 px-2 py-1 rounded text-xs w-full max-w-[120px] cursor-pointer hover:opacity-80 transition-opacity dropdown-trigger",
                            ...
                            return (
                                <div
                                    ...
                                    className={cn(
                                        ...
                                        // Use slightly lighter rendering for menu items if wanted, or reuse config
                                    )}
